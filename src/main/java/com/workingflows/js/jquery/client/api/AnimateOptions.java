...
public class AnimateOptions {
    ...
    @JsProperty
    public native Func3<Promise, Double, Double> getProgress();
    @JsProperty
    public native void setProgress(Func3<Promise, Double, Double> progress);

    @JsProperty
    public native Func getComplete();
    @JsProperty
    public native void setComplete(Func complete);

    @JsProperty
    public native Func1<Promise> getStart();
    @JsProperty
    public native void setStart(Func1<Promise> start);

    @JsProperty
    public native Func2<Promise, Boolean> getDone();
    @JsProperty
    public native void setDone(Func2<Promise, Boolean> done);

    @JsProperty
    public native Func2<Promise, Boolean> getFail();
    @JsProperty
    public native void setFail(Func2<Promise, Boolean> fail);

    @JsProperty
    public native Func2<Promise, Boolean> getAlways();
    @JsProperty
    public native void setAlways(Func2<Promise, Boolean> always);
}
